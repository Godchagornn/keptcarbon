          ...
          return (
            <g pointerEvents="none">
              ...
              <text x={ttX + ttW / 2} y={divY + (isMobile ? 36 : 40)} textAnchor="middle" fontSize={isMobile ? 26 : 30} fill="#7dd3fc" fontWeight={900}>
                {(Math.floor(p.gainValue * 10) / 10).toLocaleString("th-TH", { minimumFractionDigits: 1, maximumFractionDigits: 1 })} ±{(Math.floor(p.gainCi * 10) / 10).toLocaleString("th-TH", { minimumFractionDigits: 1, maximumFractionDigits: 1 })}
              </text>
